...
! In this example we are creating a simple 2 layer model
nz=200 ; nx=200 ; ny=200
dz=10.d0 ; dx=10.d0 ; dy=10.d0
zs=150.d0 ; xs=150.d0 ; ys=150.d0
...
! call 3D eikonal solver
 call fteik3d(slow,tt,nz,nx,ny,zs,xs,ys,dz,dx,dy,eps,n_sweep)

!write results in file in binary format
open(10,file='ttmap',access='direct',recl=4*(nx)*(nz)*(ny))
